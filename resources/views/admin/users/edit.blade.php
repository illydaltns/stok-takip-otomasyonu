...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-dark-text-primary">Kullanıcıyı Düzenle</h1>
    ...
    <div class="bg-white dark:bg-dark-bg-secondary shadow overflow-hidden rounded-lg p-6">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
             <h3 class="text-lg font-bold text-gray-800 dark:text-dark-text-primary mb-3">Şifre İşlemleri</h3>
              <form action="{{ route('admin.users.sendPasswordResetLink', $user->id) }}" method="POST">
                @csrf
                 <button type="submit"
