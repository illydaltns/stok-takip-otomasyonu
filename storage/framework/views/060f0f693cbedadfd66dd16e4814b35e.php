...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">
                          Forgot password?
                      </a>
                ...
                <div class="mt-5">
                  <form method="POST" action="<?php echo e(route('logout')); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-red-500 shadow-theme-xs hover:bg-red-600">
                      Çıkış Yap
                    </button>
                  </form>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Projelerim\StokTakipOtomasyonu\resources\views/auth/login.blade.php ENDPATH**/ ?>