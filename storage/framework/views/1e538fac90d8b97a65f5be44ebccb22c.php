                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <?php if(Auth::user()->profile_photo_path): ?>
                            <img class="w-10 h-10 rounded-full border-2 border-blue-100 dark:border-blue-900" src="<?php echo e(asset('storage/'.Auth::user()->profile_photo_path)); ?>" alt="Profil Fotoğrafı">
                        <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 dark:text-dark-text-primary truncate"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-xs text-gray-500 dark:text-dark-text-secondary truncate"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="p-1 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/20">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="<?php echo e(route('categories.index')); ?>"
                           class="flex items-center rounded-xl font-bold text-sm py-3 px-4 transition-all <?php echo e(request()->routeIs('categories.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'text-gray-700 dark:text-dark-text-secondary hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4 <?php echo e(request()->routeIs('categories.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-dark-text-secondary'); ?>" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="<?php echo e(route('products.index')); ?>"
                           class="flex items-center rounded-xl font-bold text-sm py-3 px-4 transition-all <?php echo e(request()->routeIs('products.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'text-gray-700 dark:text-dark-text-secondary hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4 <?php echo e(request()->routeIs('products.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-dark-text-secondary'); ?>" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="<?php echo e(route('sales.index')); ?>"
                           class="flex items-center rounded-xl font-bold text-sm py-3 px-4 transition-all <?php echo e(request()->routeIs('sales.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'text-gray-700 dark:text-dark-text-secondary hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4 <?php echo e(request()->routeIs('sales.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-dark-text-secondary'); ?>" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="<?php echo e(route('statistics.index')); ?>"
                           class="flex items-center rounded-xl font-bold text-sm py-3 px-4 transition-all <?php echo e(request()->routeIs('statistics.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'text-gray-700 dark:text-dark-text-secondary hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 w-5 h-5 <?php echo e(request()->routeIs('statistics.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-dark-text-secondary'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.users.index')); ?>"
                               class="flex items-center rounded-xl font-bold text-sm py-3 px-4 transition-all <?php echo e(request()->routeIs('admin.users.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'text-gray-700 dark:text-dark-text-secondary hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 w-5 h-5 <?php echo e(request()->routeIs('admin.users.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-dark-text-secondary'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
</script><?php /**PATH C:\xampp\htdocs\Projelerim\StokTakipOtomasyonu\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>